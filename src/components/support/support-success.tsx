...
export default function SupportSuccess({ onReset }: SupportSuccessProps) {
  return (
    <div className="flex flex-col items-center text-center py-16 px-8">
      ...
      <p className="text-[#6b8fb5] text-lg leading-relaxed max-w-md mb-8">
        Your support request has been received. We will contact you soon.
      </p>

      <div className="w-full max-w-sm p-5 rounded-xl mb-8"
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="text-left">
            ...
            <p className="text-xs text-[#6b8fb5] leading-relaxed">
              Our team will review your ticket and reply directly to your email address. Typical response time is within 24–48 hours.
            </p>
          </div>
        </div>
      </div>
